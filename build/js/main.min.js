...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var promoLink = document.querySelector('[data-promo-link]');
  var aboutButton = document.querySelector('[data-about-button]');
  var aboutAdditional = document.querySelector('[data-about-additional]');
  var catalogHeader = document.querySelector('[data-catalog-header]');
  var footerHeadingWrapper1 = document.querySelector('[data-heading-wrapper-1]');
  var footerHeadingWrapper2 = document.querySelector('[data-heading-wrapper-2]');
  var footerButton1 = document.querySelector('[data-footer-button-1]');
  var footerButton2 = document.querySelector('[data-footer-button-2]');
  var footerNav1 = document.querySelector('[data-nav-list-1]');
  var footerNav2 = document.querySelector('[data-nav-list-2]');
  var footerContacts = document.querySelector('[data-contacts-list]');
  ...
  [].forEach.call(document.querySelectorAll('[data-phone-input]'), function (inputElement) {
    ...
    inputElement.oninput = function () {
      ...
      var nums = inputElement.value.split(/[ ()+]+/).join('');
